      ...
      <div className="relative z-10 mx-auto flex max-w-7xl flex-col items-center gap-12 px-4 sm:px-6 md:flex-row lg:gap-16">
        <div className="w-full md:w-1/2">
          ...
          <h2 className="mb-8 font-sport text-4xl font-extrabold uppercase leading-none sm:text-6xl md:text-7xl xl:text-8xl">
            ENERGÍA DE
            <br />
            <span className="text-x-neon underline">TARAPOTO</span>
          </h2>
          <p className="mb-8 border-l-2 border-x-neon pl-5 text-base text-x-gray sm:pl-6 sm:text-xl">
            Nacimos para los que no temen al calor ni al esfuerzo. Xtreme
            Fitness es una mezcla de disciplina y alto rendimiento.
          </p>
          <div className="flex flex-wrap gap-4">
            {["Fuerza Amazónica", "Modo Xtreme", "Calor y Poder"].map((tag) => (
              <span
        ...
        <div className="relative w-full md:w-1/2">
          ...
          <div className="relative z-10 h-[300px] w-full sm:h-[400px]">
            <Image
              alt="Entrenamiento funcional en Xtreme Fitness"
          ...
          <div className="absolute -bottom-5 left-3 z-20 bg-x-neon p-4 font-sport text-2xl font-extrabold uppercase tracking-normal text-black sm:-left-6 sm:p-6 sm:text-3xl">
            HECHO EN LA SELVA
          </div>
        </div>
      </div>
